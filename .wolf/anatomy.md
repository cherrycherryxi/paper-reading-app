...
> Auto-maintained by OpenWolf. Last scanned: 2026-06-17T17:05:27.322Z
...
- `app.js` — AUTH_TOKEN_KEY: isTabActive, createId, getBackendBaseUrl + 6 more (~45388 tok)
...
- `styles.css` — Styles: 102 rules, 150 vars (~21792 tok)
...
- `backlog.md` — Optimization Backlog (~11940 tok)
- `backlog.md` — Optimization Backlog (~10520 tok)
- `explore.md` — Exploration — new optimization directions (~34589 tok)
