...
|----|-------|----------|------------|--------|-------|
| OPT-005 | debug/dashboard token & latency 监测 | P1 | S | in-progress (PR #9) | Data already in DB and returned by list_logs(); only HTML rendering missing. Add inputTokens/outputTokens per row + aggregate summary (today total, avg latency, P95). Touch: app_server.py:3208-3267. |
