...
| OPT-141 | all_books_summary 缺 tags 字段：AI 无法按标签跨书查询主题书单 | **P2** | S | triaged | `app_server.py:2632`，1-2 行 backend 改动；`app_server.py:2661` 系统指令补 tags 说明；2026-07-03 signal 佐证；Theme 2 直接受益 |
